...
<%@ page import="vesta.proyectos.Categoria; parametros.proyectos.Fuente; vesta.seguridad.Persona; parametros.Anio" contentType="text/html;charset=UTF-8" %>
<html>
    <head>
        <meta name="layout" content="main">
        <title><elm:tipoReformaStr tipo="Ajuste" tipoSolicitud="A"/></title>
    ...
    <!-- botones -->
        ...
        <elm:container tipo="horizontal" titulo="${elm.tipoReformaStr(tipo: "Ajuste", tipoSolicitud: "A")}">
            <div class="row">
                <div class="col-md-1">
                    <label for="anio">
                        POA Año
