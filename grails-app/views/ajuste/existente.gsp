...
<%@ page import="vesta.seguridad.Persona; parametros.Anio" contentType="text/html;charset=UTF-8" %>
<html>
    <head>
        <meta name="layout" content="main">
        <title><elm:tipoReformaStr tipo="Ajuste" tipoSolicitud="E"/></title>
    ...
    <!-- botones -->
        ...
        <elm:container tipo="horizontal" titulo="${elm.tipoReformaStr(tipo: "Ajuste", tipoSolicitud: "E")}">
            <div class="row">
                <div class="col-md-1">
                    <label for="anio">
                        POA Año
