...
<elm:container tipo="horizontal" titulo="Programación de asignaciones de gasto permanente, para el año ${actual}" color="black">
    <table class="table table-condensed table-bordered table-striped" style="font-size: 11px;">
        <thead>
        <tr>
            <th style="width: 90px">Enero</th>
            <th style="width: 90px">Feb.</th>
            <th style="width: 90px">Marzo</th>
            <th style="width: 90px">Abril</th>
            <th style="width: 90px">Mayo</th>
            <th style="width: 90px">Junio</th>
            <th style="width: 90px">Julio</th>
            <th style="width: 90px">Agos.</th>
            <th style="width: 90px">Sept.</th>
            <th style="width: 90px">Oct.</th>
            <th style="width: 90px">Nov.</th>
            <th style="width: 90px">Dic.</th>
