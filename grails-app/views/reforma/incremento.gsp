...
<%@ page import="seguridad.Persona; parametros.Anio" contentType="text/html;charset=UTF-8" %>
<html>
    <head>
        <meta name="layout" content="main">
        <title><elm:tipoReformaStr tipo="Reforma" tipoSolicitud="I"/></title>
    ...
    <!-- botones -->
        ...
        <elm:container tipo="horizontal" titulo="${elm.tipoReformaStr(tipo: "Reforma", tipoSolicitud: "I")}">
            <div class="row">
                <div class="col-md-1">
                    <label for="anio">
                        POA Año
                        ...
                        if ($("#frmFirma").valid()) {
                            ...
                            $.ajax({
                                ...
                                success : function (msg) {
                                    ...
                                    if (parts[0] == "SUCCESS") {
                                        setTimeout(function () {
                                            location.href = "${createLink(action:'incremento')}/" + parts[2];
                                        }, 2000);
                                    } else {
                                        closeLoader();
                                    }
