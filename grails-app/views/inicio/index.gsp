...
<div class="dialog">
    ...
    <div class="row mbr-justify-content-center">
        ...
        <a href= "${createLink(controller:'encuesta', action: 'listaEncuestas')}" style="text-decoration: none">
            <div class="col-lg-6 mbr-col-md-10">
                <div class="wrap" style="height: 70px">
                    <div style="width: 100px; height: 60px">
                        <asset:image src="apli/evaluacion.png" title="Aplicar encuesta" width="80%" height="80%"/>
                    ...
                    <div style="width: 900px; height: 120px">
                        <h2 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"><span>Asignar informante</span></h2>
                        <p class="mbr-fonts-style text1 mbr-text display-6">Seleccionar el informante para la encuesta.</p>
                    </div>
                </div>
            </div>
        </a>
