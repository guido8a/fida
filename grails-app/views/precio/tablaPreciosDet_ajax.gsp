...
<script type="text/javascript">
    ...
    function borrarPrecioDetalle (id, detalle){
        bootbox.confirm({
                    ...
                    $.ajax({
                        ...
                        success: function (msg) {
                            ...
                            if(msg == 'ok'){
                                ...
                                limpiarPrecioDetalle(detalle);
                                cargarTablaDetalleDet(detalle);
                            }else{
            ...
            <tr>
                ...
                <td style="width: 10%">
                    <g:if test="${detalle?.proyecto?.estado != 'R'}">
                        <a href="#" class="btn btn-danger btn-xs btnBorrarPrecioDetalle" onclick="borrarPrecioDetalle('${precio?.id}', '${precio?.detallePrecio?.id}')"  title="Borrar precio"><i class="fa fa-trash"></i> </a>
                    </g:if>
                </td>
            </tr>
        </g:each>
