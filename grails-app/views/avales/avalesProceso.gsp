                    ...
                    <table class="table table-condensed table-bordered table-striped table-hover" style="margin-top: 20px">
                        ...
                        <g:each in="${solicitudes}" var="p">
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <g:if test="${p.path}">
                                        <a href="#" class="btn descRespaldo btn-info btn-xs" iden="${p.id}"><i class="fa fa-search"></i> Ver
                                        </a>
                                    </g:if>
                                </td>
                                <td style="text-align: center">
                                    <g:if test="${p.tipo != 'A'}">
                                        <a href="#" class="imprimirSolicitud btn btn-info btn-xs" iden="${p.id}" title="Imprimir">
                                            <i class="fa fa-print "></i>
                                        </a>
                                    </g:if>
                                    <g:else>
                                        <a href="#" class="imprimirNegacion btn btn-info btn-xs" iden="${p.id}" title="Imprimir">
                                            <i class="fa fa-print "></i>
                                        </a>
                                    </g:else>
                                </td>
