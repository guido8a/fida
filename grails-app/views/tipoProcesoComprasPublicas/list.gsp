...
<div class="btn-toolbar toolbar">
    ...
    <div class="btn-group">
        <a href="#" class="btn btn-default btnCrear">
            <i class="fa fa-clipboard-list"></i> Nuevo tipo de proceso
        </a>
    </div>
</div>
...
<table class="table table-condensed table-bordered table-striped table-hover">
    ...
    <g:if test="${procesos.size() > 0}">
        <g:each in="${procesos}" var="proceso">
...
<script type="text/javascript">
    ...
    function deleteRow(itemId) {
        bootbox.dialog({
            ...
            message : "<i class='fa fa-trash fa-3x pull-left text-danger text-shadow'></i><p>" +
                "¿Está seguro que desea eliminar el tipo de proceso seleccionado? Esta acción no se puede deshacer.</p>",
            buttons : {
                cancelar : {
                    label     : "Cancelar",
                ...
                eliminar : {
                    ...
                    callback  : function () {
                        $.ajax({
                            type    : "POST",
                            url     : '${createLink(controller: 'tipoProcesoComprasPublicas', action:'delete_ajax')}',
                            data    : {
                                id : itemId
                            },
                            success : function (msg) {
    ...
    function createEditRow(id) {
        ...
        $.ajax({
            type    : "POST",
            url     : "${createLink(controller: 'tipoProcesoComprasPublicas', action:'form_ajax')}",
            data    : data,
            success : function (msg) {
