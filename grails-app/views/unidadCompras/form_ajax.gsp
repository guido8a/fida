...
<g:if test="${!unidadComprasInstance}">
...
<g:else>
    <g:form class="form-horizontal" name="frmOrms" role="form" action="save_ajax" method="POST" useToken="true">
        <g:hiddenField name="id" value="${unidadComprasInstance?.id}" />
        
        <div class="form-group ${hasErrors(bean: unidadComprasInstance, field: 'nombre', 'error')} ">
            <span class="grupo">
                ...
                <div class="col-md-2">
                    <g:textField name="codigo" maxlength="15" class="form-control required allCaps"
                                value="${unidadComprasInstance?.codigo}"/>
                </div>
            </span>
        </div>
            ...
            <span class="grupo">
                ...
                <div class="col-md-8">
                    <g:textArea name="descripcion" maxlength="63" class="form-control required"
                                value="${unidadComprasInstance?.descripcion}" style="height: 75px; resize: none"/>
                </div>
