...
<g:else>
    <g:form class="form-horizontal" name="frmOrms" role="form" action="save_ajax" method="POST" useToken="true">
        ...
        <div class="form-group ${hasErrors(bean: fuenteInstance, field: 'nombre', 'error')} ">
            <span class="grupo">
            ...
            <span class="grupo">
                ...
                <div class="col-md-8">
                    <g:textArea name="descripcion" maxlength="63" class="form-control required"
                                value="${fuenteInstance?.descripcion}" style="height: 75px; resize: none"/>
                </div>
