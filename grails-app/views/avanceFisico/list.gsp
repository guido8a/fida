...
<head>
    ...
    <asset:stylesheet src="/semaforos.css"/>
</head>
...
<div class="row no-margin-top">
    <div class="col-md-4">
        <div class="btn-toolbar toolbar">
            <div class="btn-group">
                <g:link controller="avales" action="listaProcesos" class="btn btn-default"><i class="fa fa-arrow-left"></i> Lista de procesos</g:link>
            </div>
        </div>
    </div>
...
<fieldset>
    ...
    <div class="row">
        <div class="col-md-7 alert alert-info sh" style="height: 100%;">
            ...
            <div class="row no-margin-top">
                <label class="col-md-2 control-label">Reportar cada</label>
        ...
        <div class="col-md-5 alert alert-success sh" style="height: 100%;">
            ...
            <div class="row no-margin-top" style="margin-left: 150px">
