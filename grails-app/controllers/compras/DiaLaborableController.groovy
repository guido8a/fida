...
//        println("params calendario " + params)
...
//            params.anio = Anio.get(params.anio).anio
        }
        ...
        if (dias.size() < 365) {
            ...
            def nuevoAnio = Anio.findByAnio(params.anio)
...
//                    println "guardado: " + fecha.format("dd-MM-yyyy") + "   " + dia + " ordinal:" + ordinal
        ...
        return [anio: anio, dias: dias, meses: meses, params: params, listaAnios: Anio.list().sort{it.anio}]
    }
