...
//        println "pro "+proyectos
        ...
        if (params.id) {
            ...
            if (!estados.contains(reforma.estado)) {
                println "esta en estado: ${reforma.estado.descripcion} (${reforma.estado.codigo}) redirecciona a la lista"
        ...
        reformas = Reforma.withCriteria {
            ...
            persona {
                if(params.requirente){
                    eq("unidadEjecutora", UnidadEjecutora.get(params.requirente))
                } else {
