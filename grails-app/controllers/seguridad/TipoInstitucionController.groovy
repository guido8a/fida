...
class TipoInstitucionController {
    ...
    def index(Integer max) {
        ...
        respond tipoInstitucionService.list(params), model:[tipoInstitucionCount: tipoInstitucionService.count()]
    }
...
/*
    def save_ajax() {
        ...
        if (!tipoInstitucionInstance.save(flush: true)) {
            println "${tipoInstitucionInstance.errors}"
            render "ERROR*Ha ocurrido un error al guardar TipoElemento: " + renderErrors(bean: tipoInstitucionInstance)
            return
        }
...
*/
    ...
    def show(Long id) {
        respond tipoInstitucionService.get(id)
    }
